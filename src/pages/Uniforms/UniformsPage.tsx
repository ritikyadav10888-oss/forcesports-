                        ...
                        {(isMobileFiltersOpen || (typeof window !== 'undefined' && window.innerWidth >= 1024)) && (
                            <motion.aside 
                                ...
                                className={`
                                    ...
                                    lg:relative lg:inset-y-auto lg:right-auto lg:w-72 lg:p-0 lg:shadow-none lg:border-none lg:bg-transparent lg:z-auto
                                            ...
                                            <div className="mb-6">
                                                ...
                                                <div className="space-y-4">
                                                    {UniformCategories.map(cat => {
                                                        ...
                                                        // Only show subcategories for School
                            ...
                            <AnimatePresence>
                                {filteredUniforms.map(uniform => (
                                    <motion.div
                                        ...
                                        onClick={() => navigate(`/uniforms/${uniform.id}`)}
                                    >
